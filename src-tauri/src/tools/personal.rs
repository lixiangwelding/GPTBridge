...
fn open(ctx: &ToolContext, args: &Value) -> coding_tools_personal_runtime::Result<Value> {
    ...
    view["delivery"] = super::delivery::policy(ctx.workspace.root());
